...
USAGE EXAMPLES:
    ...
    python test_autogen.py --list-resources
    
    # Focus on cognitive services with detailed info
    python test_autogen.py --cognitive
    
    # Enable debug output for troubleshooting
    python test_autogen.py --debug
    
    # Combine options
    python test_autogen.py --cognitive --debug
    python test_autogen.py --list-resources --debug
